//
//  MapsFlipViewController.swift
//  Yelp
//
//  Created by Patwardhan, Saurabh on 10/23/16.
//  Copyright © 2016 Timothy Lee. All rights reserved.
//

import UIKit
import MapKit
class MapsFlipViewController: UIViewController, MKMapViewDelegate, UISearchBarDelegate, FiltersViewControllerDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        } else if (segue.identifier == "mapsToListSegue"){
            let navigationController = segue.destination as! UINavigationController
            let businessesViewController = navigationController.topViewController as! BusinessesViewController
            
            businessesViewController.filter = filter
            businessesViewController.searchTerm = searchTerm
